      ...
      <div className="max-w-[1240px] mx-auto py-12">
        <div className="text-center py-8 text-slate-300">
          ...
          <p className="text-3xl">
            ...
            consequuntur debitis reiciendis labore, deserunt harum nemo libero
            incidunt ratione modi.
          </p>
        </div>

        <div className="grid md:grid-cols-2">
          <div className="relative bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl">
          ...
          <div className="relative bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl">
            ...
            <div>
              <p className="text-6xl font-bold py-4">
                $89<span className="text-xl text-slate-500">/mo</span>
              </p>
            </div>
            <p className="text-2xl py-6 text-slate-500">
              Lorem, ipsum dolor sit amet consectetur adipisicing.
